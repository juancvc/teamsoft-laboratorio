...
@NamedStoredProcedureQueries({	
	...
	@NamedStoredProcedureQuery(name = "acceso.listar", 
		...
		resultClasses = Acceso.class,
		parameters = {
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_CODIPERF", type = String.class),
			@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_CODCOMPA", type = String.class)
	}),
