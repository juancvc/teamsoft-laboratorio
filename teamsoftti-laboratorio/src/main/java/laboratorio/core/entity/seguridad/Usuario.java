...
package laboratorio.core.entity.seguridad;
...
@NamedStoredProcedureQueries({
		...
		@NamedStoredProcedureQuery(name = "usuario.autenticar", procedureName = "SEGU.USP_USUARIO_AUTENTICAR", resultClasses = Usuario.class, parameters = {
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_nomusuar", type = String.class),
				@StoredProcedureParameter(mode = ParameterMode.IN, name = "p_pswusuar", type = String.class) }),
