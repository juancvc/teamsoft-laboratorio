...
import laboratorio.core.entity.asistencial.laboratorio.Tarifario_laboratorio;
import laboratorio.core.entity.general.Tgemae02;
import laboratorio.core.repository.DAOException;
import laboratorio.core.repository.interfaces.general.TarifarioDAO;
...
public class TarifarioDAOImpl implements TarifarioDAO {
	...
	public List<TarifarioBean> getBuscarPorFiltros(TarifarioBean TarifarioBean)
		...
		List<TarifarioBean> lstTablaBean = null;
			...
			spq.setParameter("p_TG1TIPOT", TarifarioBean.getTipo().getCodReg()); 
			spq.setParameter("p_DESCRIPC", TarifarioBean.getDescripcion()); 
			if (spq.execute()) {
