...
import laboratorio.core.entity.seguridad.SigehoUsuario;
import laboratorio.core.entity.seguridad.Usuario;
...
public class UsuarioDAOImp implements UsuarioDAO {
	...
	public UsuarioBean autenticar(UsuarioBean prmUsuarioBean) throws DAOException {
		...
		try {
			...
			spq.setParameter("p_nomusuar", prmUsuarioBean.getNombreUsuario());
			spq.setParameter("p_pswusuar", prmUsuarioBean.getPasswordUsuario());
