...
import laboratorio.core.entity.seguridad.Acceso;
import laboratorio.core.repository.DAOException;
import laboratorio.core.repository.interfaces.seguridad.AccesoDAO;
...
public class AccesoDAOImp implements AccesoDAO {
	...
	public List<AccesoBean> getBuscarPorFiltros(AccesoBean accesoBean)
		...
		try {
			...
			spq.setParameter("p_CODIPERF", accesoBean.getPerfil().getCodigo());
	        spq.setParameter("p_CODCOMPA", accesoBean.getComponente().getCodigoComponentePadre()); 
