...
<%@page import="laboratorio.core.bean.seguridad.UsuarioBean"%>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>${usuarioSesion.persona.primerNombre} ${usuarioSesion.persona.apellidoPaterno}</p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Orden</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="${pageContext.request.contextPath}/ordenController/nuevo"><i class="fa fa-circle-o"></i> Generar</a></li>
            <li><a href="${pageContext.request.contextPath}/ordenController/listado"><i class="fa fa-circle-o"></i> Listado</a></li> 
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
